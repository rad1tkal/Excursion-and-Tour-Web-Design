...
<?php
	...
	if(isset($_POST['simpan']))
	{
		...
		mysqli_query($connection, "insert into hotel values('$hotelkode', '$hotelnama','$hotelalamat','$kategoriharga', '$kamartersedia','$hoteltelp', '$areakode')");
...
<!-- flag input -->
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="namahotel" name="inputnama" placeholder="Nama Hotel" maxlength="60" required="">
    </div>
  </div>
  <div class="form-group row">
    <label for="alamathotel" class="col-sm-2 col-form-label">Alamat Hotel</label>
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="alamathotel" name="inputalamat" placeholder="Alamat Hotel" maxlength="60">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="hoteltelp" name="inputnotelp" placeholder="Nomor Telfon Hotel" maxlength="12">
    </div>
  </div>
