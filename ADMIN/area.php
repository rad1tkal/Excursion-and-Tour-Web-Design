...
<?php
	...
	if(isset($_POST['simpan']))
	{
		...
		mysqli_query($connection, "insert into area values('$areakode', '$areanama','$areawilayah','$areaketerangan', '$kodeprovinsi')");
...
<!-- flag input -->
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="namaarea" name="inputnama" placeholder="Nama area" maxlength="35" >
    </div>
  </div>
  <div class="form-group row">
    <label for="areawilayah" class="col-sm-2 col-form-label">Wilayah</label>
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="areawilayah" name="inputwilayah" placeholder="Wilayah area" maxlength="35">
    </div>
  </div>
  <div class="form-group row">
    <label for="areaketerangan" class="col-sm-2 col-form-label">Keterangan</label>
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="areaketerangan" name="inputketerangan" placeholder="Keterangan area" maxlength="255">
    </div>
  </div>
		...
		<table class="table table-hover table-danger">
			...
			<?php 
				...
				while($row = mysqli_fetch_array($query)){
					...
					<td>
						<a href="areaedit.php?ubah=<?php echo $row["areaID"]?>" class="btn-success btn-sm" title="Edit">
					...
					<td>
						<a href="areadelete.php?hapus=<?php echo $row["areaID"]?>" class="btn-danger btn-sm" title="Delete">
