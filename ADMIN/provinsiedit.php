...
<?php
  ...
  $temp = $_GET["ubah"];
  $editprovinsi = mysqli_query($connection, "SELECT * FROM provinsi WHERE provinsiID = '$temp'");
...
?>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="provinsiid" name="inputprovinsiid" value="<?php echo $rowedit["provinsiID"] ?>"   readonly>
    </div>
  </div>
  <div class="form-group row">
    <label for="provinsinama" class="col-sm-2 col-form-label">Nama Provinsi</label>
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="provinsinama" name="inputprovinsinama" value="<?php echo $rowedit["provinsinama"] ?>" >
    </div>
  </div>
  <div class="form-group row">
    <label for="provinsitglberdiri" class="col-sm-2 col-form-label">Tanggal Berdiri</label>
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="provinsitglberdiri" name="inputprovinsitglberdiri" value="<?php echo $rowedit["provinsitglberdiri"]?>" >
    </div>
  </div>
