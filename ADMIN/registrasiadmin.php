...
<head>
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="namaadmin" name="inputnama" placeholder="Nama Admin" maxlength="30" required="">
    </div>
  </div>
  <div class="form-group row">
    <label for="emailadmin" class="col-sm-2 col-form-label">Email</label>
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="emailadmin" name="inputemail" placeholder="Email" maxlength="60" required="">
    </div>
  </div>
  <div class="form-group row">
    <label for="passwordadmin" class="col-sm-2 col-form-label">Password</label>
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="passwordadmin" name="inputpassword" placeholder="Password" maxlength="255" required="">
    </div>
  </div>
  <div class="form-group row">
    <div class="col-sm-2">
...
<!-- flag search bar -->
      ...
      <div class="form-group row mb-2">
        ...
        <div class="col-sm-6">
          <input type="text" name="search" class="form-control" id="search" placeholder="Cari Admin" value="<?php if(isset($_POST['search'])){ echo $_POST['search'];}?>">
