...
//untuk menampilkan data pada form edit
	$temp = $_GET["ubah"];
	$editdestinasi = mysqli_query($connection, "SELECT * FROM destinasi WHERE destinasiID = '$temp'");
	$rowedit = mysqli_fetch_array($editdestinasi); 
	$editkategori = mysqli_query($connection, "SELECT * FROM destinasi, kategori WHERE destinasiID = '$temp' AND destinasi.kategoriID = kategori.kategoriID;");
	$rowedit2 = mysqli_fetch_array($editkategori);
	$editarea = mysqli_query($connection, "SELECT * FROM destinasi, area WHERE destinasiID = '$temp' AND destinasi.areaID = area.areaID;");
		...
		<table class="table table-hover table-danger">
			...
			if(isset($_POST["kirim"])){
				...
				while($row = mysqli_fetch_array($query)){
					...
					<td>
						<a href="edit.php?ubah=<?php echo $row["destinasiID"]?>" class="btn-success btn-sm" title="Edit">
					...
					<td>
						<a href="delete.php?hapus=<?php echo $row["destinasiID"]?>" class="btn-danger btn-sm" title="Delete">
