...
<?php
	...
	if(isset($_POST['simpan']))
	{
		...
		mysqli_query($connection, "insert into sewakendaraan values('$sewakode', '$sewanama','$sewaalamat','$sewajenis','$harga','$sewatelp','$areakode')");
...
<!-- flag input -->
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="alamatsewa" name="inputalamat" placeholder="Alamat Tempat Sewa" maxlength="60"  required="">
    </div>
  </div>
  <div class="form-group row">
  ...
  <div class="form-group row">
    ...
    <div class="col-sm-10">
      <input type="Text" class="form-control" id="sewatelp" name="inputnotelp" placeholder="Nomor Telfon Sewa" maxlength="12">
    </div>
  </div>
