...
<?php 
  ...
  $restoran= mysqli_query($connection, "SELECT * FROM restoran, fotorestoran,area WHERE restoran.restoranID = fotorestoran.restoranID AND area.areaID = restoran.areaID");
...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="#tampilan" style="color:maroon;">Restoran</a>
          </li>
          <li class="nav-item">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4" style="color:maroon;">Restoran</h1>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="title-box text-center">
              ...
              <p class="subtitle-a">
                Berbagai macam pilihan Restoran
              </p>
  ...
  <?php if(mysqli_num_rows($restoran) > 0){
    while($row2= mysqli_fetch_array($restoran)){ ?>
      <div class="media" style=" padding: 10px;">
        <div class="media-body">
          <h4 class="mt-0 mb-1" style="color: maroon; " ><?php echo $row2['restorannama'] ?></h4>
          <h5><?php echo $row2['restoranalamat'] ?></h5>
          <p><?php echo "Harga: ".$row2['kategoriharga'] ?></p>
          <p><?php echo $row2['restoranketerangan']; ?></p>
