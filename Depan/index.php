    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="#tampilan" style="color:maroon;">Destinasi</a>
          </li>
          <li class="nav-item">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4" style="color:maroon;">Wisata</h1>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="title-box text-center">
              ...
              <p class="subtitle-a">
                Berbagai macam pilihan destinasi wisata
              </p>
    ...
    while($row2= mysqli_fetch_array($destinasi)){ ?>
      <div class="media" style=" padding: 10px;">
        <div class="media-body">
          <h4 class="mt-0 mb-1" style="color: maroon; " ><?php echo $row2['destinasinama'] ?></h4>
