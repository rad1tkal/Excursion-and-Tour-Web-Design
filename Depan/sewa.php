...
<?php 
  ...
  $hotel= mysqli_query($connection, "SELECT * FROM hotel, fotohotel WHERE hotel.hotelID = fotohotel.hotelID");
  $restoran= mysqli_query($connection, "SELECT * FROM restoran, fotorestoran WHERE restoran.restoranID = fotorestoran.restoranID");
  $sewa= mysqli_query($connection, "SELECT * FROM sewakendaraan,area WHERE area.areaID = sewakendaraan.areaID");
...
<body id="page-top">
    ...
    <div class="container">
      ...
      <div class="navbar-collapse collapse justify-content-end" id="navbarDefault">
        <ul class="navbar-nav">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll" href="#tampilan" style="color:maroon;">Sewa Kendaran</a>
          </li>
          <li class="nav-item">
    ...
    <div class="intro-content display-table">
      <div class="table-cell">
        <div class="container">
          ...
          <h1 class="intro-title mb-4" style="color:maroon;">Sewa Kendaraan</h1>
        ...
        <div class="row">
          <div class="col-sm-12">
            <div class="title-box text-center">
              ...
              <p class="subtitle-a">
                Berbagai macam pilihan kendaraan
              </p>
  ...
  <?php if(mysqli_num_rows($sewa) > 0){
    while($row2= mysqli_fetch_array($sewa)){ ?>
      <div class="media" style=" padding: 10px;">
        <div class="media-body">
          <h4 class="mt-0 mb-1" style="color: maroon; " ><?php echo $row2['sewanama'] ?></h4>
          <h5><?php echo $row2['sewaalamat'] ?></h5>
          <p><?php echo "Harga: ".$row2['sewaharga'] ?></p>
          <p><?php echo $row2['sewajenis'].", ".$row2['sewatelp'] ?></p>
          <p><?php echo "Area: ".$row2['areanama'] ?></p>
        </div>
        <?php
        if($row2['sewajenis']=="Mobil(MPV)"){?>
        <img class="ml-3" style="width:300px; height:180px;" src="images/mpv.png" alt="Gambar Tidak Ada">
        <?php } ?>
        <?php
        if($row2['sewajenis']=="Mobil(Van)"){?>
        <img class="ml-3" style="width:300px; height:180px;" src="images/van.png" alt="Gambar Tidak Ada">
        <?php } ?>
        <?php
        if($row2['sewajenis']=="Mobil(Pickup)"){?>
        <img class="ml-3" style="width:300px; height:180px;" src="images/pickup.png" alt="Gambar Tidak Ada">
        <?php } ?>
        <?php
        if($row2['sewajenis']=="Motor"){?>
        <img class="ml-3" style="width:300px; height:180px;" src="images/motor.png" alt="Gambar Tidak Ada">
        <?php } ?>
      </div>
    <?php }} ?>
    </div>
